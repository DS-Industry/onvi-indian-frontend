...
export default function Home() {
  const [order, setOrder] = useState({ bay: "", sum: "" });
  ...
  const handleOrderClick = (
    ...
    router.push(`/pay?sum=${sum}&box=${order.bay}`);
  };
  ...
  return (
    <UnAuthLayout>
      <Suspense fallback={<div>Loading...</div>}>
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-lg">
            ...
            <div className="flex justify-center pt-2">
              <Image src={PayLogo.src} width="38" height="38" className="object-contain" alt="Pay Logo" />
            </div>
            <p className="mx-auto mt-4 max-w-md text-center text-gray-500">
              Enter the amount you want to enter on the terminal and select the most
        ...
        <div
          role="alert"
          className={`${isError ? "visible absolute top-3" : "invisible"
            } w-full flex justify-center`}
        >
          <div className="rounded border-s-4 border-red-500 bg-error-50 p-4 mx-2 border-l-red-500 z-30 md:w-1/2 sm:w-full flex justify-between items-start">
            <div className="flex flex-col">
              ...
              <p className="mt-2 text-sm text-error-700">
                Maybe you didn’t select a bay number. Please try again.
              </p>
            </div>
            <button
